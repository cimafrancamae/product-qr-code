...
import { Bleed, BlockStack, Button, Card, ChoiceList, Divider, EmptyState, InlineError, InlineStack, Layout, Page, PageActions, TextField, Thumbnail } from "@shopify/polaris";
...
export async function action({ request, params }) {
  ...
  const qrCode = 
    params.id === "new"
      ...
      : await db.qRCode.update({ where: { id: Number(params.id) 
    }, data });
